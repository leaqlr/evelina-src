...
class Logging(Cog):
    ...
    @logs_ignore.command(name="add", brief="manage guild", usage="logs ignore add accurs")
    @has_guild_permissions(manage_guild=True)
    ...
    @logs_ignore.command(name="remove", brief="manage guild", usage="logs ignore remove accurs")
    @has_guild_permissions(manage_guild=True)
