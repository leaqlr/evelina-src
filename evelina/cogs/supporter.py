...
class Supporter(Cog):
    ...
    @donor.command(name="add", usage="donor add accurs", brief="bot supporter")
    @is_supporter()
    ...
    @donor.command(name="remove", usage="donor remove accurs", brief="bot supporter")
    @is_supporter()
    ...
    @bug.command(name="add", brief="bot supporter", usage="bug add accurs Permission Bug")
    @is_supporter()
    ...
    @bug.command(name="list", brief="bot supporter", usage="bug list accurs")
    @is_supporter()
    ...
    @premium.command(name="add", usage="premium add accurs /evelina", brief="bot supporter")
    @is_supporter()
    ...
    @premium.command(name="remove", usage="premium remove accurs /evelina", brief="bot supporter")
    @is_supporter()
    ...
    @premium.command(name="inspect", usage="premium inspect accurs", brief="bot supporter")
    @is_supporter()
