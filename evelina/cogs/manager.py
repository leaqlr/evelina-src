...
class Manager(Cog):
    ...
    @beta.command(name="add", brief="bot manager", usage="beta add accurs")
    @is_manager()
    ...
    @beta.command(name="remove", brief="bot manager", usage="beta remove accurs")
    @is_manager()
    ...
    @creator.command(name="add", brief="bot manager", usage="creator add accurs")
    @is_manager()
    ...
    @creator.command(name="remove", brief="bot manager", usage="creator remove accurs")
    @is_manager()
    ...
    @instances.command(name="setup", brief="bot manager", usage="instances setup evelina accurs /evelina")
    @is_manager()
    ...
    @instances_transfer.command(name="owner", brief="bot manager", usage="instances transfer owner accurs curet")
    @is_manager()
    ...
    @authorized.command(name="add", brief="bot manager", usage="authorized add accurs /evelina")
    @is_manager()
    ...
    @authorized.command(name="remove", brief="bot manager", usage="authorized remove accurs /evelina")
    @is_manager()
