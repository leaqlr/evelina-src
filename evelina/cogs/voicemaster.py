...
class Voicemaster(Cog):
    ...
    @voice.command(name="permit", brief="voice owner", usage="voice permit accurs", description="Permit a member or role to join your voice channel")
    @check_vc_owner()
    @bot_has_guild_permissions(manage_channels=True)
    ...
    @voice.command(name="reject", brief="voice owner", usage="voice reject accurs", description="Reject a member or role from joining your voice channel")
    @check_vc_owner()
    @bot_has_guild_permissions(manage_channels=True)
    ...
    @voice.command(name="kick", brief="voice owner", usage="voice kick accurs", description="Kick a member or role from joining your voice channel")
    @check_vc_owner()
    @bot_has_guild_permissions(manage_channels=True)
    ...
    @voice.command(name="transfer", brief="voice owner", usage="voice transfer accurs", description="Transfer ownership of your voice channel to another member")
    @check_vc_owner()
    ...
    @voice_preset.command(name="edit", usage="voice preset edit friends accurs")
