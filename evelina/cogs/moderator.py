...
from modules.predicates import is_moderator
...
class Moderator(Cog):
    ...
    @command(usage="anowner 1228371886690537624 accurs", brief="bot moderator")
    @is_moderator()
    ...
    @money.command(name="add", usage="money add cash accurs 125", brief="bot moderator")
    @is_moderator()
    ...
    @money.command(name="remove", usage="money remove cash accurs 125", brief="bot moderator")
    @is_moderator()
    ...
    @money.command(name="set", usage="money set cash accurs 125", brief="bot moderator")
    @is_moderator()
    ...
    @command(usage="mutuals accurs", brief="bot moderator")
    @is_moderator()
    ...
    @usage.command(name="user", usage="usage user accurs userinfo", brief="bot moderator")
    @is_moderator()
    ...
    @usage_economy.command(name="user", brief="bot moderator", usage="usage economy user accurs")
    @is_moderator()
    ...
    @blacklist.command(name="user", brief="bot manager", usage="blacklist user accurs 24h spamming")
    @is_moderator()
    ...
    @blacklist.command(name="command", brief="bot manager", usage="blacklist command accurs userinfo 24h spamming")
    @is_moderator()
    ...
    @blacklist.command(name="cog", brief="bot manager", usage="blacklist cog accurs utility 24h spamming")
    @is_moderator()
    ...
    @blacklist.command(name="check", brief="bot manager", usage="blacklist check accurs")
    @is_moderator()
    ...
    @unblacklist.command(name="user", brief="bot manager", usage="unblacklist user accurs")
    @is_moderator()
    ...
    @unblacklist.command(name="command", brief="bot manager", usage="unblacklist command accurs userinfo")
    @is_moderator()
    ...
    @unblacklist.command(name="cog", brief="bot manager", usage="unblacklist cog accurs utility")
    @is_moderator()
