...
class Antiraid(Cog):
    ...
    @antiraid.command(name="whitelist", aliases=["wl"], brief="administrator", usage="antiraid whitelist accurs")
    @has_guild_permissions(administrator=True)
    @antiraid_configured()
    ...
    @antiraid.command(name="unwhitelist", aliases=["uwl"], brief="administrator", usage="antiraid unwhitelist accurs", description="Unwhitelist a user or role from Antiraid system")
    @has_guild_permissions(administrator=True)
    @antiraid_configured()
