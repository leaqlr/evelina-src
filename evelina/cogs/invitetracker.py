...
class InviteTracker(Cog):
    ...
    @invites_bonus.command(name="add", brief="manage guild", usage="invites bonus add accurs 5")
    @has_guild_permissions(manage_guild=True)
    ...
    @invites_bonus.command(name="remove", brief="manage guild", usage="invites bonus remove accurs 5")
    @has_guild_permissions(manage_guild=True)
    ...
    @invites.command(name="inviter", aliases=["invited-by"], usage="invites inviter accurs")
    ...
    @invites.command(name="invited", usage="invites invited accurs")
    ...
    @invites.command(name="code", usage="invites code accurs")
