...
class Lastfm(Cog):
    ...
    @lastfm.command(name="chart", aliases=["c"], usage="lastfm chart accurs 3x3 7day", description="View a collage of your most listened to albums")
    ...
    @lastfm.command(name="plays", aliases=["p"], usage="lastfm plays accurs", description="Get the total amount of plays of a user for certain artist")
    ...
    @lf_mode.command(name="view", brief="donator", usage="lastfm mode view accurs", description="View your custom lastfm embed or someone's lastfm embed")
    @has_perks()
    ...
    @lf_mode.command(name="steal", brief="donator", usage="lastfm mode steal accurs", description="Steal someone's lastfm embed")
    @has_perks()
    ...
    @lastfm.command(name="spotify", aliases=["sp"], usage="lastfm spotify accurs", description="Look up for your nowplaying lastfm song on spotify")
    ...
    @lastfm.command(name="topartists", aliases=["ta", "tar"], usage="lastfm topartists accurs", description="Get the top artists of a user")
    ...
    @lastfm.command(name="toptracks", aliases=["tt"], usage="lastfm toptracks accurs", description="Get the top tracks of a user")
    ...
    @lastfm.command(name="topalbums", aliases=["tal"], usage="lastfm topalbums accurs", description="Get the top albums of a user")
    ...
    @lastfm.command(name="user", aliases=["ui", "profile"], usage="lastfm user accurs", description="Get information about a user's lastfm account")
    ...
    @lastfm.command(name="taste", usage="lastfm taste accurs", description="Compare your music taste between you and someone else")
    ...
    @lastfm.command(name="cover", aliases=["image"], usage="lastfm cover accurs", description="Get the cover image of your lastfm song")
    ...
    @lastfm.command(name="recent", usage="lastfm recent accurs", description="Get the most recent songs of a user")
    ...
    @command(aliases=["np", "fm"], usage="nowplaying accurs", description="Get the latest song scrobbled on Last.Fm")
            ...
            if check[2]:
                ...
                try:
                    ...
                    embed = (
                        ...
                        .set_footer(text=f"Playcount: {await self.lastfmhandler.get_track_playcount(user, first_track)} ∙ Total Scrobbles: {a['recenttracks']['@attr']['total']} {f'∙ Album: {album}' if album else ''}")
                    )
