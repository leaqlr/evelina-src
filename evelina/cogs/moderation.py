...
class Moderation(Cog):
    ...
    @command(brief="manage roles", usage="restore accurs")
    ...
    @command(brief="manage messages", usage="jail accurs 1d reason --s", extras={"s": "Punish a user silently"})
    ...
    @command(brief="manage messages", usage="unjail accurs rassist --s", extras={"s": "Punish a user silently"})
    @has_guild_permissions(manage_messages=True)
    @bot_has_guild_permissions(manage_roles=True)
    @is_jail()
    ...
    @history.command(name="user", aliases=["u"], brief="manage messages", usage="history user accurs")
    @has_guild_permissions(manage_messages=True)
    ...
    @history.command(name="moderator", aliases=["mod", "m"], brief="moderate members", usage="history moderator accurs")
    ...
    @history_clear.command(name="user", brief="manage guild", usage="history clear user accurs")
    @has_guild_permissions(manage_guild=True)
    ...
    @history_clear.command(name="moderator", aliases=["mod", "m"], brief="manage guild", usage="history clear moderator accurs")
    @has_guild_permissions(manage_guild=True)
    ...
    @command(name="modstats", brief="moderate members", usage="modstats accurs")
    @has_guild_permissions(moderate_members=True)
    ...
    @command(name="voicemove", aliases=["drag"], brief="move members", usage="voicemove accurs")
    ...
    @command(name="voicekick", brief="move members", usage="voicekick accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voicemute", brief="move members", usage="voicemute accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voiceunmute", brief="move members", usage="voiceunmute accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voicedeafen", brief="move members", usage="voicedeafen accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voiceundeafen", brief="move members", usage="voiceundeafen accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voiceban", brief="move members", usage="voiceban accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @command(name="voiceunban", brief="move members", usage="voiceunban accurs")
    @has_guild_permissions(move_members=True)
    @bot_has_guild_permissions(move_members=True)
    ...
    @clear.command(name="mentions", brief="manage message", usage="clear mentions accurs")
    @has_guild_permissions(manage_messages=True)
    @bot_has_guild_permissions(manage_messages=True)
    ...
    @command(brief="moderate members", aliases=["timeout"], usage="mute accurs 1d rassist --s", extras={"s": "Punish a user silently"})
    @has_guild_permissions(moderate_members=True)
    ...
    @command(brief="moderate members", aliases=["untimeout"], usage="unmute accurs rassist --s", extras={"s": "Punish a user silently"})
    @has_guild_permissions(moderate_members=True)
    @bot_has_guild_permissions(moderate_members=True)
    ...
    @command(brief="moderate members", usage="imute accurs #chat")
    @has_guild_permissions(moderate_members=True)
    @bot_has_guild_permissions(manage_channels=True, manage_roles=True)
    ...
    @command(brief="moderate members", usage="iunmute accurs #chat")
    @has_guild_permissions(moderate_members=True)
    @bot_has_guild_permissions(manage_channels=True, manage_roles=True)
    ...
    @command(brief="moderate members", usage="rmute accurs #chat")
    @has_guild_permissions(moderate_members=True)
    @bot_has_guild_permissions(manage_channels=True, manage_roles=True)
    ...
    @command(brief="moderate members", usage="runmute accurs #chat")
    @has_guild_permissions(moderate_members=True)
    @bot_has_guild_permissions(manage_channels=True, manage_roles=True)
    ...
    @command(brief="ban members", usage="ban accurs rassist --days 7", extras={"s": "Punish a user silently", "days": "Delete messages from the user"})
    ...
    @command(brief="kick members", usage="kick accurs rassist --s", extras={"s": "Punish a user silently"})
    ...
    @command(brief="ban members", usage="unban accurs --s", extras={"s": "Punish a user silently"})
    @has_guild_permissions(ban_members=True)
    @bot_has_guild_permissions(ban_members=True)
    ...
    @command(brief="manage roles", usage="strip accurs")
    @has_guild_permissions(manage_roles=True)
    @bot_has_guild_permissions(manage_roles=True)
    ...
    @command(aliases=["nick"], brief="manage nicknames", usage="nickname accurs bender")
    ...
    @warn.command(name="remove", brief="manage messages", usage="warn remove accurs 1")
    @has_guild_permissions(manage_messages=True)
    ...
    @warn.command(name="clear", brief="manage messages", usage="warn clear accurs")
    @has_guild_permissions(manage_messages=True)
    ...
    @warn.command(name="list", usage="warn list accurs")
    @has_guild_permissions(manage_messages=True)
    ...
    @thread.command(name="add", brief="manage threads", usage="thread add accurs")
    @has_guild_permissions(manage_threads=True)
    @bot_has_guild_permissions(manage_threads=True)
    ...
    @thread.command(name="remove", brief="manage threads", usage="thread remove accurs")
    @has_guild_permissions(manage_threads=True)
    @bot_has_guild_permissions(manage_threads=True)
    ...
    @command(name="hardban", brief="administrator & antinuke admin", usage="hardban accurs rassist")
    @has_guild_permissions(administrator=True)
    @bot_has_guild_permissions(ban_members=True)
    @admin_antinuke()
    ...
    @command(name="unhardban", brief="administrator & antinuke admin", usage="unhardban accurs rassist")
    @has_guild_permissions(administrator=True)
    @bot_has_guild_permissions(ban_members=True)
    @admin_antinuke()
    ...
    @command(name="revokefiles", brief="manage messages", usage="revokefiles on accurs nsfw")
    @has_guild_permissions(manage_messages=True)
    ...
    async def case_proof(self, ctx: EvelinaContext, case: int, proof: str = None):
        ...
        if ctx.message.attachments:
            ...
            if response:
                ...
                file_url = f"https://cdn.yourbot.bot/c/{file_name}"
