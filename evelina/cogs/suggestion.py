...
class Suggestion(Cog):
    ...
    @suggestion.command(name="blacklist", brief="Manage guild", usage="suggestion blacklist accurs Spamming")
    @has_guild_permissions(manage_guild=True)
    @suggestion_enabled()
    ...
    @suggestion.command(name="unblacklist", brief="Manage guild", usage="suggestion unblacklist accurs")
    @has_guild_permissions(manage_guild=True)
    @suggestion_enabled()
