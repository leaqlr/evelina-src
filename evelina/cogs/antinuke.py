...
class Antinuke(Cog):
    ...
    async def antinuke_setup(self, ctx: EvelinaContext):
        ...
        await ctx.send_success("Antinuke is **enabled**\n> You can check [**here**](https://docs.yourbot.dev/security/antinuke#antinuke-recommended-configuration) our recommend antinuke configuration")
    ...
    @antinuke.command(name="whitelist", aliases=["wl"], brief="antinuke admin", usage="antinuke whitelist accurs", description="Whitelist a user or role from Antinuke system")
    @antinuke_configured()
    @admin_antinuke()
    ...
    @antinuke.command(name="unwhitelist", aliases=["uwl"], brief="antinuke admin", usage="antinuke unwhitelist accurs", description="Unwhitelist a user or role from Antinuke system")
    @antinuke_configured()
    @admin_antinuke()
    ...
    @antinuke_admin.command(name="add", brief="antinuke owner", usage="antinuke admin add accurs", description="Give a user permissions to edit Antinuke settings")
    @antinuke_configured()
    @antinuke_owner()
    ...
    @antinuke_admin.command(name="remove", brief="antinuke owner", usage="antinuke admin remove accurs", description="Remove a user permissions to edit Antinuke settings")
    @antinuke_configured()
    @antinuke_owner()
