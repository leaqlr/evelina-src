...
class Boosterrole(Cog):
    ...
    @br_blacklist.command(name="user", brief="Manage guild", usage="boosterrole blacklist user accurs Spamming")
    @has_guild_permissions(manage_guild=True)
    ...
    @br_unblacklist.command(name="user", brief="Manage guild", usage="boosterrole unblacklist user accurs")
    @has_guild_permissions(manage_guild=True)
    ...
    @boosterrole.command(name="wipe", brief="manage guild", usage="boosterrole wipe accurs")
    @has_guild_permissions(manage_guild=True)
    @br_is_configured()
    ...
    @br_share.command(name="add", brief="server booster", usage="boosterrole share add accurs")
    @br_is_configured()
    @has_br_role()
    ...
    @br_share.command(name="remove", brief="server booster", usage="boosterrole share remove accurs")
    @br_is_configured()
    @has_br_role()
    @boosterrole_blacklisted()
