...
class Whitelist(Cog):
    ...
    @whitelist.command(name="add", brief="administrator", usage="whitelist add accurs")
    @has_permissions(administrator=True)
    @whitelist_enabled()
    ...
    @whitelist.command(name="remove", brief="administrator", usage="whitelist remove accurs")
    @has_permissions(administrator=True)
    @whitelist_enabled()
