...
class Ticket(Cog):
    ...
    @ticket.command(name="allow", aliases=["add"], brief="ticket support / manage channels", usage="ticket allow accurs", description="Add a user or role to the ticket")
    @manage_ticket()
    @get_ticket()
    ...
    @ticket.command(name="unallow", aliases=["remove"], brief="ticket support / manage channels", usage="ticket unallow accurs", description="Remove a user or role from the ticket")
    @manage_ticket()
    @get_ticket()
    ...
    @ticket.command(name="info", brief="manage guild", usage="ticket info accurs", description="View all tickets from a given user")
    @has_guild_permissions(manage_guild=True)
    @ticket_exists()
    ...
    @ticket.command(name="blacklist", brief="Manage guild", usage="ticket blacklist accurs Spamming")
    @has_guild_permissions(manage_guild=True)
    @ticket_exists()
    ...
    @ticket.command(name="unblacklist", brief="Manage guild", usage="ticket unblacklist accurs")
    @has_guild_permissions(manage_guild=True)
    @ticket_exists()
    ...
    @ticket_admin.command(name="add", brief="administrator", usage="ticket admin add accurs", description="Give a user permissions to view ticket transcripts")
    @has_guild_permissions(administrator=True)
    @ticket_exists()
    ...
    @ticket_admin.command(name="remove", brief="administrator", usage="ticket admin remove accurs", description="Remove a user's permissions to view ticket transcripts")
    @has_guild_permissions(administrator=True)
    @ticket_exists()
