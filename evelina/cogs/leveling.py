...
class Leveling(Cog):
    ...
    @command(name="rank", usage="rank accurs", description="View your level and experience")
    ...
    @level.command(name="set", brief="manage guild", usage="level set accurs 15", description="Set a user's level")
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    ...
    @level.command(name="reset", brief="manage guild", usage="level reset accurs", description="Reset a user's level and XP")
    @has_guild_permissions(manage_guild=True)
    @leveling_enabled()
    ...
    @level_ignore.command(name="add", brief="manage guild", usage="level ignore add accurs")
    @has_guild_permissions(manage_guild=True)
    ...
    @level_ignore.command(name="remove", brief="manage guild", usage="level ignore remove accurs")
    @has_guild_permissions(manage_guild=True)
