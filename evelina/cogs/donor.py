...
class Donor(Cog):
    ...
    @forcenick.command(name="set", brief="manage nicknames, donator", usage="forcenick set accurs King")
    ...
    @forcenick.command(name="remove", brief="manage nicknames, donator", usage="forcenick remove accurs")
    ...
    @command(name='impersonate', aliases=['imp'],  brief="donator", usage='impersonate accurs hi')
    @has_perks()
    ...
    @command(name='uwulock', usage="uwulock accurs", brief="donator")
    @has_perks()
    ...
    async def reverse(self, ctx: EvelinaContext, *, url: str = None):
        ...
        try:
            ...
            data = await self.bot.session.get_json(
                f"https://api.yourbot.bot/google/reverse",
    ...
    @command(name="deeplookup", aliases=["dlu", "deep"], brief="donator", usage="deeplookup accurs")
    @has_perks()
