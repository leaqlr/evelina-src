...
class Developer(Cog):
    ...
    @command(aliases=["gban"], brief="bot developer", usage="globalban accurs Hate speech")
    @is_developer()
    ...
    @command(name="termed", brief="bot developer", usage="termed accurs curet")
    @is_developer()
    async def termed(self, ctx: EvelinaContext, old: User, new: User):
        """Transfer data from old user to new user"""
        details = ""
        allowed_roles = {
        930383131863842816, 320288667329495040, 585689685771288600
        }
    ...
    @command(name="wipe", brief="bot developer", usage="wipe accurs")
    @is_developer()
    ...
    @command(name="wipeall", brief="bot developer", usage="wipeall accurs")
    @is_developer()
    ...
    @staff.command(name="add", usage="staff add accurs developer", brief="bot developer")
    @is_developer()
    ...
    @staff.command(name="edit", usage="staff edit accurs developer", brief="bot developer")
    @is_developer()
    ...
    @staff_social.command(name="forceadd", usage="staff social forceadd accurs instagram https://instagram.com/bender6pm", brief="bot developer")
    @is_developer()
    ...
    @staff_social.command(name="forceremove", usage="staff social forceremove accurs instagram", brief="bot developer")
    @is_developer()
    ...
    @staff_social.command(name="forceedit", usage="staff social forceedit accurs instagram https://instagram.com/bender6pm", brief="bot developer")
    @is_developer()
    ...
    @staff_social.command(name="forcelist", usage="staff social forcelist accurs", brief="bot developer")
    @is_developer()
