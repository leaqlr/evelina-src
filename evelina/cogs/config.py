...
class Config(Cog):
    ...
    async def embed_post(self, ctx: EvelinaContext, name: str, *, code: str):
        ...
        if ctx.message.attachments:
            ...
            if upload_res:
                file_url = f"https://cdn.yourbot.bot/e/{file_name}"
    ...
    @usertrack.command(name="avatar", brief="manage guild", usage="usertrack avatar https://cdn.yourbot.bot/e/12345678.png")
    @has_guild_permissions(manage_guild=True)
    ...
    @vanitytrack.command(name="avatar", brief="manage guild", usage="vanitytrack avatar https://cdn.yourbot.bot/e/12345678.png")
    @has_guild_permissions(manage_guild=True)
